[![Build Status](https://api.travis-ci.com/dzmitryd07/js-assignments.svg?token=imB4LondxFssptqGvJKz&branch=master)](https://travis-ci.com/github/dzmitryd07/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'dzmitryd07'` with your account name).
...
```
* Open https://github.com/dzmitryd07/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/dzmitryd07/js-assignments/builds).
